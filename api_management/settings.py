...
SECRET_KEY = "django-insecure-$bvc3hh#9x%bb8u)g&^o8z+435k4r(ziysv-+*+^j88q$#!n)r"
...
INSTALLED_APPS = [
    ...
    "corsheaders",     # CORS Headers for API permissions
]
...
CORS_ALLOWED_ORIGINS = [
    ...
    'https://react-user-api-amber.vercel.app',  # React production build
]
